...
// ANSI Escape code untuk warna background ledakan
...
// Function untuk menggerakan kursor ke koordinat tertentu
void moveTo(int row, int col) {
  stdout.write('\x1B[${row};${col}H]');
}

// Function untuk mencetak Fireworks sebelum meledak
...
Future<void> kembangApi(centerX, centerY, String colorSelect) async {
  ...
  for (int i = centerY; i > centerY - 5; i--) {
  ...
  String explosionBackground = explosionBackgroundColors[
      Random().nextInt(explosionBackgroundColors.length)];
